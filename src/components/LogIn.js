    ...
    <button class="uppercase px-4 py-2 rounded-full bg-purple-500 text-blue-50 max-w-max shadow-sm hover:shadow-lg">Sign Up</button>
      ...
      <form action="">
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
          ...
          <div class="py-0 px-10 h-6 grid gid-col-3 grid-flow-col">
            <input
              className="uppercase px-4 py-2 rounded-full bg-purple-500 text-blue-50 max-w-max shadow-sm hover:shadow-lg"
              type="submit"
              value="Sign In"
            />
            <Link to="/sign-up">
              <button class="uppercase px-4 py-2 rounded-full bg-purple-500 text-blue-50 max-w-max shadow-sm hover:shadow-lg">
                Sign Up
              </button>
            </Link>
          </div>
